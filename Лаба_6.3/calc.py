...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_del.setStyleSheet("background-color: rgb(121, 121, 121);")
        ...
        self.pushButton_00.setMinimumSize(QtCore.QSize(50, 50))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.pushButton_00.setFont(font)
        self.pushButton_00.setObjectName("pushButton_00")
        self.horizontalLayout_3.addWidget(self.pushButton_00)
